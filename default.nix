...
let
  ...
  burpHash = "sha256-1h4b54aifpjg0fapjfj1l6gq8ixhcd2ijqf4kjkilnjpx152k1v2";
...
buildFHSEnv {
  ...
  meta = with lib; {
    ...
    changelog = "https://portswigger.net/burp/releases/professional-community-" + replaceStrings ["."] ["-"] version;
